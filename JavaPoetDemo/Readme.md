...
[JavaPoet](https://github.com/square/javapoet) 库使用的学习记录


* [Main.java](https://github.com/103style/Demos/blob/master/JavaPoetDemo/app/src/main/java/com/lxk/javapoetdemo/Main.java)
```
public class Main {
    public static void main(String[] args) {
        new JavaPoetTest().run();
    }
}
```

* [JavaPoetTest.java](https://github.com/103style/Demos/blob/master/JavaPoetDemo/app/src/main/java/com/lxk/javapoetdemo/JavaPoetTest.java)
```
...
* 生成的代码结果
```
public class JavaPoetGenerateClass<T> extends ArrayList<T> implements Serializable, Comparable<JavaPoetGenerateClass<? extends T>> {
  private static final String TAG = "JavaPoetGenerateClass";
  ...
  public JavaPoetGenerateClass() {
  }

  public JavaPoetGenerateClass(int initialCapacity) {
  ...
  @Override
  public int compareTo(JavaPoetGenerateClass<? extends T> o) {
    int res;
    if(size() > o.size()) {
      res = 1;
    } else if(size() == o.size()) {
  ...
  public <T> int examples(String string, T t, Map<Integer, ? extends T> map) throws IOException,
      RuntimeException {
    int foo = 1;
    String bar = "a string";
    Object obj = new HashMap<Integer, JavaPoetGenerateClass<? extends T>>(5);
    new Runnable() {
      @Override
      public void run() {
      }
